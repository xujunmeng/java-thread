...
//            (thread) -> new Thread(thread,"test-thread"));
    ...
    /**
     * 参考文档：https://www.cnblogs.com/fingerboy/p/9948736.html
     */
    @Test
    public void testxdf() {
        ...
        try {
            ...
            try {
                test1Result = test1CompletableFuture.get(100, TimeUnit.MILLISECONDS);
            } catch (Exception e) {
                System.out.println(e);
            ...
            try {
                test2Result = test2CompletableFuture.get(100, TimeUnit.MILLISECONDS);
            } catch (Exception e) {
                System.out.println(e);
            ...
            try {
                test3Result = test3CompletableFuture.get(100, TimeUnit.MILLISECONDS);
            } catch (Exception e) {
                System.out.println(e);
